...
// Deepslate Ore
val RUBY_DEEPSLATE_ORE = registerBlock("ruby_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_EMERALD_ORE)))
val SAPPHIRE_DEEPSLATE_ORE = registerBlock("sapphire_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_EMERALD_ORE)))
val TOPAZ_DEEPSLATE_ORE = registerBlock("topaz_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_EMERALD_ORE)))

val ZINC_DEEPSLATE_ORE = registerBlock("zinc_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
val TIN_DEEPSLATE_ORE = registerBlock("tin_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
val SILVER_DEEPSLATE_ORE = registerBlock("silver_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
val PLATINUM_DEEPSLATE_ORE = registerBlock("platinum_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
val TITANIUM_DEEPSLATE_ORE = registerBlock("titanium_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
val COBALT_DEEPSLATE_ORE = registerBlock("cobalt_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
val MITHRIL_DEEPSLATE_ORE = registerBlock("mithril_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
val ORICHALCUM_DEEPSLATE_ORE = registerBlock("orichalcum_deepslate_ore", Block(FabricBlockSettings.copy(Blocks.DEEPSLATE_IRON_ORE)))
...
val PLATINUM_RAW_BLOCK = registerBlock("platinum_raw_block", Block(FabricBlockSettings.copy(Blocks.RAW_IRON_BLOCK)))
val TITANIUM_RAW_BLOCK = registerBlock("titanium_raw_block", Block(FabricBlockSettings.copy(Blocks.RAW_IRON_BLOCK)))
val COBALT_RAW_BLOCK = registerBlock("cobalt_raw_block", Block(FabricBlockSettings.copy(Blocks.RAW_IRON_BLOCK)))
val MITHRIL_RAW_BLOCK = registerBlock("mithril_raw_block", Block(FabricBlockSettings.copy(Blocks.RAW_IRON_BLOCK)))
val ORICHALCUM_RAW_BLOCK = registerBlock("orichalcum_raw_block", Block(FabricBlockSettings.copy(Blocks.RAW_IRON_BLOCK)))
