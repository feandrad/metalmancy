...
object ModBlockTags {
    ...
    val ZINC_BLOCKS = createTag("zinc_blocks", "c")
    ...
    val BRASS_BLOCKS = createTag("bronze_blocks", "c")
    val BRONZE_BLOCKS = createTag("bronze_blocks", "c")
    val STEEL_BLOCKS = createTag("steel_blocks", "c")

    private fun createTag(name: String, c: String = MOD_ID): TagKey<Block> =
        TagKey.of(RegistryKeys.BLOCK, Identifier(c, name));
}
...
object ModItemTags {
    ...
    private fun createTag(name: String, c: String = MOD_ID): TagKey<Item> =
        TagKey.of(RegistryKeys.ITEM, Identifier(c, name));
}