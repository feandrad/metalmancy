...
object ToolMaterialUtility {
    ...
    private fun createBlockTag(name: String): TagKey<Block> =
        TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("metalmancy", name))

    private fun createItemTag(name: String): TagKey<Item> =
        TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("metalmancy", name))
